            ...
            switch (operationResponse.OperationCode)
            {
                ...
                case OperationCode.CreateGame:
                    ...
                    if (this.State == ClientState.Joined)
                    {
                        ...
                        this.loadBalancingPeer.OpRaiseEvent(DemoConstants.EvColor, this.LocalPlayer.WriteEvColor(), true, new RaiseEventOptions { CachingOption = EventCaching.AddToRoomCache });
                    }
                    break;
            }

...
public class ConnectionDialog : MonoBehaviour 
{
    ...
    public string appId;    // set this public field in the inspector (will override any value you set here)
    ...
    void OnGUI()
    {
        if (showConnectionDialog)
        {
            ...
            {
                this.gameObject.GetComponent<DemoGUI>().Init(masterServerAddress, appId, gameVersion);
